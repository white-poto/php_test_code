...
define('SIMPLE_PROCESS_ROOT', dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'SimpleProcess' . DIRECTORY_SEPARATOR);
...
$manager->fork(new SimpleProcess\Process(function() { sleep(7); }, "My super cool2 process"));
do
{
